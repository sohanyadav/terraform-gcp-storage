...
```hcl
module "bucket_logs" {
  source      = "https://github.com/sohanyadav/terraform-gcp-storage.git"
  name        = "dev-logs-0909"
  environment = "test"
  location    = "asia"
}
...
# Examples
For detailed examples on how to use this module, please refer to the [example](https://github.com/sohanyadav/terraform-gcp-storage/tree/master/_example) directory within this repository.
...
## License
This project is licensed under the MIT License - see the [LICENSE](https://github.com/sohanyadav/terraform-gcp-storage/blob/master/LICENSE) file for details.
...
| <a name="input_labels"></a> [labels](#input\_labels) | ManagedBy, sohanyadav | `map(any)` | `{}` | no |
